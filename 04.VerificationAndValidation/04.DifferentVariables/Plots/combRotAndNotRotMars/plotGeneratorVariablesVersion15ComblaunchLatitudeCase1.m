...
currentVariableFolder = 'launchLatitude';
...
legend('Rotating','Rotating fit','Non rotating','Non rotating fit','Location','NorthEastOutside'); % Add a legend in the top right corner
set(gca,'FontSize',14);  % Make sure that the graph font size is 14
