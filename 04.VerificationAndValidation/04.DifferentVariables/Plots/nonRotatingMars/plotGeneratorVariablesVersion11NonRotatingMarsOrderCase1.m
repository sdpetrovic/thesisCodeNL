...
axis([min(currentVariable) max(currentVariable) 0.0 0.05]) % First zoom
...
figure(9)
semilogy(currentVariable,functionEvaluationsTSI)
...
axis([min(functionEvaluationsTSI) max(functionEvaluationsTSI) 0.0 0.04]) % Zoom
