...
title(['Time vs ','z position correct order']); % Give the figure a title
xlabel('Time [s]'); % Label the different axes
ylabel('z position [km]');
...
title(['Time vs ','x velocity correct order']); % Give the figure a title
xlabel('Time [s]'); % Label the different axes
ylabel('x velocity [km]');
...
title(['Time vs ','y velocity correct order']); % Give the figure a title
xlabel('Time [s]'); % Label the different axes
ylabel('y velocity [km]');
...
title(['Time vs ','z velocity correct order']); % Give the figure a title
xlabel('Time [s]'); % Label the different axes
ylabel('z velocity [km]');
